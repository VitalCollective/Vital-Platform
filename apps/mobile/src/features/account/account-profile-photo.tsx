...
export function AccountProfilePhoto({ id, profile, disabled, onBusyChange, onChanged }: {
  ...
  async function choose() {
    ...
    try {
      ...
      onChanged(saved); setNotice(hasPhoto ? 'Your profile photo has been changed.' : 'Your profile photo has been added.');
    } catch (cause) {
  ...
  async function remove() {
    ...
    try {
      ...
      onChanged(saved); setConfirmingRemoval(false); setNotice('Your profile photo has been removed.');
    } catch (cause) {
  ...
  return <View style={a.stack}>
    <View style={a.row}>
      ...
      <View style={a.grow}><Text style={a.label}>Profile photo</Text><Text style={a.meta}>Shown with your Community posts and replies. If you remove it, your initials are used instead.</Text></View>
    </View>
    ...
    {!confirmingRemoval ? <View style={a.stack}>
      ...
      <Text style={a.body}>Remove your current profile photo? Your initials will appear instead.</Text>
