# Vital Collective brand assets

These are the approved Vital Collective brand artworks. Do not replace them with generated, improvised or typographic substitutes.
...
The global app shell continues to use its typographic lockup until the secondary logo is deliberately integrated and checked at header scale. Expo's legacy icon files are unchanged in this pass; `vital-mark.png` is the approved source treatment for a later dedicated favicon/app-icon export. The small Vital mark is a logo, not a decorative leaf icon, and should remain reserved for intentional brand placements.
